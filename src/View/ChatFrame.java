...
public class ChatFrame extends javax.swing.JFrame {
    ...
    // Tao HashMap với khóa là tên người nhận tin nhắn và values là nội dung chat của người dùng hieenje tại với khóa(người dùng dc chat chung)
    ...
    private void initComponents() {
        ...
        jPanel3.add(txtChat);
        txtChat.setBounds(240, 490, 590, 39);
